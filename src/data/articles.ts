...
export const ARTICLES: Article[] = [
  {
    ...
    content: `
<p className="text-base sm:text-lg text-[#4B5563] leading-relaxed mb-6 font-medium">
...
<div className="bg-[#0F231B]/5 border border-[#00E68A]/30 rounded-2xl p-5 mb-8">
  <div className="flex items-center gap-2 text-[#00E68A] font-bold text-sm mb-2">
    <span className="material-symbols-outlined text-base">shield</span>
    Ключевое правило безопасности
  </div>
  <p className="text-xs sm:text-sm text-[#1A1D20] m-0">
...
<h2 className="text-xl sm:text-2xl font-bold text-[#111111] font-display mt-8 mb-4">
...
<div className="my-6 text-center">
  <img src="/blog/funnel-scheme.png" alt="Схема интеграции ИИ и безопасной работы" className="rounded-xl border border-[#E5E7EB] shadow-sm max-w-full mx-auto" />
  <span className="block text-xs text-[#828D99] mt-2">Схема двухконтурной обработки данных и передача сообщений</span>
</div>

<ul className="space-y-2 mb-6">
  <li className="flex items-start gap-2 text-sm text-[#1A1D20]">
    <span className="text-[#00E68A] font-bold">1.</span>
  ...
  <li className="flex items-start gap-2 text-sm text-[#1A1D20]">
    <span className="text-[#00E68A] font-bold">2.</span>
  ...
  <li className="flex items-start gap-2 text-sm text-[#1A1D20]">
    <span className="text-[#00E68A] font-bold">3.</span>
  ...
  <li className="flex items-start gap-2 text-sm text-[#1A1D20]">
    <span className="text-[#00E68A] font-bold">4.</span>
...
<div className="overflow-x-auto my-6 border border-[#E5E7EB] rounded-2xl bg-white shadow-sm">
  <table className="w-full text-left text-sm text-[#1A1D20]">
    <thead className="bg-[#F9FAFB] border-b border-[#E5E7EB] text-xs uppercase font-bold text-[#828D99]">
      <tr>
        <th className="p-4">Критерий</th>
        <th className="p-4">Штатный менеджер</th>
        <th className="p-4 text-[#00E68A]">ИИ-агент Samartsev AI</th>
      </tr>
    </thead>
    <tbody className="divide-y divide-[#E5E7EB]">
      <tr>
        <td className="p-4 font-semibold">Время ответа</td>
        <td className="p-4 text-red-500 font-medium">15–90 минут</td>
        <td className="p-4 text-[#00E68A] font-bold">2–3 секунды</td>
      </tr>
      <tr>
        <td className="p-4 font-semibold">Режим работы</td>
        <td className="p-4">5/2, с 9:00 до 18:00</td>
        <td className="p-4 font-semibold">24/7/365 без перерывов</td>
      </tr>
      <tr>
        <td className="p-4 font-semibold">Затраты на внедрение</td>
        <td className="p-4">От 60 000 ₽ / мес ФОТ + налоги</td>
        <td className="p-4 font-semibold">Фиксированный проект (окупаемость 1 мес)</td>
      </tr>
      <tr>
        <td className="p-4 font-semibold">Защита 152-ФЗ</td>
        <td className="p-4">Риск утечек из-за человеческого фактора</td>
        <td className="p-4 font-semibold">Двухконтурная изоляция на серверах РФ</td>
      </tr>
    </tbody>
  </table>
</div>
...
<div className="my-6 text-center">
  <img src="/blog/cat-funnel.png" alt="Кот разбирает сценарии автоматизации у доски" className="rounded-xl border border-[#E5E7EB] shadow-sm max-w-md mx-auto" />
  <span className="block text-xs text-[#828D99] mt-2">Проектирование логики сценариев и условных переходов на доске</span>
</div>
...
<div className="overflow-x-auto my-6 border border-[#E5E7EB] rounded-2xl bg-white shadow-sm">
  <table className="w-full text-left text-sm text-[#1A1D20]">
    <thead className="bg-[#F9FAFB] border-b border-[#E5E7EB] text-xs uppercase font-bold text-[#828D99]">
      <tr>
        <th className="p-4">Характеристика</th>
        <th className="p-4">Make.com</th>
        <th className="p-4 text-[#00E68A]">Self-Hosted n8n</th>
        <th className="p-4">Custom Code</th>
      </tr>
    </thead>
    <tbody className="divide-y divide-[#E5E7EB]">
      <tr>
        <td className="p-4 font-semibold">Локализация данных</td>
        <td className="p-4 text-red-500">Зарубежные сервера</td>
        <td className="p-[#00E68A] p-4 font-bold">100% РФ сервер (VPS)</td>
        <td className="p-4">РФ сервер</td>
      </tr>
      <tr>
        <td className="p-4 font-semibold">Оплата за операции</td>
        <td className="p-4">Плата за каждое действие</td>
        <td className="p-4 font-bold text-[#00E68A]">Безлимитно (только VPS)</td>
        <td className="p-4">Безлимитно</td>
      </tr>
      <tr>
        <td className="p-4 font-semibold">Скорость внесения правок</td>
        <td className="p-4">Высокая</td>
        <td className="p-4 font-bold text-[#00E68A]">Высокая (Low-code визуализатор)</td>
        <td className="p-4 text-red-500">Низкая (нужен разработчик)</td>
      </tr>
    </tbody>
  </table>
</div>
...
<div className="my-6 text-center">
  <img src="/blog/cat-crisis.png" alt="Кот в утомлении у ноутбука из-за пропущенных звонков" className="rounded-xl border border-[#E5E7EB] shadow-sm max-w-md mx-auto" />
  <span className="block text-xs text-[#828D99] mt-2">Типичная ситуация: пропущенные звонки и сообщения в нерабочее время</span>
</div>

<div className="bg-[#F3F4F6] border-l-4 border-[#00E68A] p-5 rounded-r-2xl my-6">
  <div className="font-bold text-sm text-[#111111] mb-1">📐 Математическая формула упущенной прибыли:</div>
  <code className="text-xs sm:text-sm text-[#1A1D20] font-mono block bg-white p-3 rounded-lg border border-[#E5E7EB]">
